...
public class TabView extends RelativeLayout {
    ...
    private int mTabTextViewBackground;
    /**
    ...
    private Integer unselectedTabIcon;
    ...
    private List<LinearLayout> mChildViews = new ArrayList<>();
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        ...
        } else if (attr == R.styleable.TabView_tab_tabViewWidth) {
            mTabViewWidth = typedArray.getDimensionPixelSize(attr, mTabViewWidth);
        } else if (attr == R.styleable.TabView_tab_textViewBackground) {
            mTabTextViewBackground = typedArray.getResourceId(attr, mTabTextViewBackground);
        }
    }
    private void initView(Context context){
        ...
        if(mTabViewGravity== Gravity.BOTTOM){
            ...
            if (mTabViewWidth == 0) {
                ...
                tabviewParams = new LayoutParams(mTabViewHeight, TabViewUtil.dp2px(context,mTabViewWidth));
            }
        ...
        tabview.setBackgroundResource(R.drawable.tab_bar_bg);
    ...
    private void initTabChildView(){
        ...
        for(int i=0;i<mFragments.length;i++){
            ...
            unselectedTabIcon = t.getTabViewUnSelIcon();
        }
...
//            if (mTabTextViewBackground == 0)
//            tabChildParams.bottomMargin = 15;
            ...
            if(mImageViewWidth == 0 || mImageViewHeight == 0){
                ivParams=new LinearLayout.LayoutParams(
            ...
            if (mTabTextViewBackground != 0)
            textview.setBackgroundResource(mTabTextViewBackground);
...
//            textviewParams.gravity=Gravity.CENTER_HORIZONTAL|Gravity.CENTER_VERTICAL;
            ...
            tabChild.setBackgroundResource(t.getTabViewUnSelIcon());
            ...
            if(mTabViewDefaultPosition>=mTabViewChildList.size()){
                if(i==0){
                    ...
                    tabChild.setBackgroundResource(t.getTabViewSelIcon());
                }
            }else{
    ...
    private void reSetAll(){
        for(int i=0;i<tabview.getChildCount();i++){
            ...
            for(int j=0;j<tabChild.getChildCount();j++){
                ...
                tabChild.setBackgroundResource(unselectedTabIcon);
            }
        }
    }
    ...
    public void setTabViewBackgroundColor(int color){
        ...
        tabview.setBackgroundResource(color);
    }

    public void setTabTextViewBackgroundColor(int color){
        tabview.setBackgroundResource(color);
    }
