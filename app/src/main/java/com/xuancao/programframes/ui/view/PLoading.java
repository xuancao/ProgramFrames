 ...
 * Loading View
 */
public class PLoading extends View {
    ...
    private final int DEFAULT_COLOR = 0xFF3688FF;
    ...
    public PLoading(Context context) {
        this(context, null);
    }

    public PLoading(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PLoading(Context context, AttributeSet attrs, int defStyleAttr) {
